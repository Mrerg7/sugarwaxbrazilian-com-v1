...
export const ACQUISITION_MAILTO = `mailto:${SITE.email}?subject=${encodeURIComponent('sugarbrazilianwax.com Domain Acquisition Inquiry')}&body=${encodeURIComponent('Hello,\n\nI am interested in acquiring sugarbrazilianwax.com.\n\nIntended use:\nBudget range:\n\nThank you.')}`;
